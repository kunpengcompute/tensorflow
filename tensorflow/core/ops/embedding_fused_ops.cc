...
REGISTER_OP("KPFusedDirectHashMod")
    .Input("data: T")
    .Input("add_y: int64")
    .Input("mod_y: int64")
    .Output("output: int64")
...
REGISTER_OP("KPFusedDynamicPadding")
    .Input("data: T")
    .Input("sub_x: int32")
    .Input("less_y: int32")
    .Output("output_less: bool")
    .Output("output: T")
    .Attr("T: {int32, int64}")
    .Attr("rank: int = 0")
    .SetShapeFn(shape_inference::UnknownShape);

REGISTER_OP("KPFusedTopKSegmentMin")
    .Input("scores_tensor: float")
    .Input("k_tensor: int32")
    .Input("ids_tensor: int64")
    .Input("attrs_tensor: int64")
