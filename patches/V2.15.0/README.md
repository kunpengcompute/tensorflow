...
切换 `--feature-set` 即可创建其他组合。KDNN profile 还需要按照 KDNN 安装文档提供
对应的头文件和库。

## Legacy 补丁

`frozen_feature/tensorflow_2.15.0-legacy.patch` 是独立、冻结的历史功能集合。
...
用于维护和验证补丁。`feature/` 下的文件是生成物，不应手工修改；`frozen_feature/`
