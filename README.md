...
关于鲲鹏TensorFlow 2.15.0的特性详细介绍请参见《[特性介绍](./docs/zh/2.15.0/feature_introduction.md)》。

## Tensorflow 2.20.0特性介绍

| 特性 | 状态 | 简介 |
| --- | --- | --- |
| FlashAttentionGraphOptimization(FAGO)静态图融合 | 维护中 | 提供面向推荐推理场景的FlashAttentionForward算子。 |

关于鲲鹏TensorFlow 2.20.0的特性详细介绍请参见《[特性介绍](./docs/zh/2.20.0/feature_introduction.md)》。

## Tensorflow 2.15.0补丁发布
...
当前维护的补丁系列需要按特性组合生成 `tensorflow/feature_copts.bzl`，请参见`patches`目录下的《[README](./patches/2.15.0/README.md)》构建源码。

Legacy补丁只允许独立应用到官方基线，不依赖公共构建集成（common），也不保证与其他补丁兼容。详细说明请参见《[README](./patches/2.15.0/README.md)》。

## Tensorflow 2.20.0.补丁发布
...
当前维护的补丁系列需要按特性组合生成 `tensorflow/feature_copts.bzl`，请参见`patches`目录下的《[README](./patches/2.20.0/README.md)》构建源码。
...
关于鲲鹏TensorFlow 2.15.0的版本更新情况请参见《[版本说明书](./docs/zh/2.15.0/release_notes.md)》。

关于鲲鹏TensorFlow 2.20.0的版本更新情况请参见《[版本说明书](./docs/zh/2.20.0/release_notes.md)》。
...
<th class="cellrowborder" valign="top" width="17.64176417641764%" id="mcps1.1.4.1.2"><p id="p13918183762016">2.15.0 学习资源名称</p></th>
<th class="cellrowborder" valign="top" width="17.64176417641764%" id="mcps1.1.4.1.3"><p id="p13918183762016">2.20.0 学习资源名称</p></th>
...
<td class="cellrowborder" valign="top" width="17.64176417641764%" headers="mcps1.1.4.1.2"><p id="p2091893722011"><a href="./docs/zh/2.15.0/release_notes.md">版本说明书</a></p></td>
<td class="cellrowborder" valign="top" width="17.64176417641764%" headers="mcps1.1.4.1.3"><p id="p2091893722011"><a href="./docs/zh/2.20.0/release_notes.md">版本说明书</a></p></td>
...
<tr id="row179181137112015">
<td class="cellrowborder" valign="top" width="17.64176417641764%" headers="mcps1.1.4.1.2"><p id="p2091893722011"><a href="./docs/zh/2.15.0/feature_introduction.md">特性介绍</a></p></td>
<td class="cellrowborder" valign="top" width="17.64176417641764%" headers="mcps1.1.4.1.3"><p id="p2091893722011"><a href="./docs/zh/2.20.0/feature_introduction.md">特性介绍</a></p></td>
...
<td class="cellrowborder" valign="top" width="17.64176417641764%" headers="mcps1.1.4.1.2"><p id="p03913372046"><a href="./docs/zh/2.15.0/quick_start.md">快速入门</a></p></td>
<td class="cellrowborder" valign="top" width="17.64176417641764%" headers="mcps1.1.4.1.3"><p id="p03913372046"><a href="./docs/zh/2.20.0/quick_start.md">快速入门</a></p></td>
...
<td class="cellrowborder" valign="top" width="17.64176417641764%" headers="mcps1.1.4.1.2"><p id="p17918337172020"><a href="./docs/zh/2.15.0/installation_guide.md">安装指南</a></p></td>
<td class="cellrowborder" valign="top" width="17.64176417641764%" headers="mcps1.1.4.1.3"><p id="p17918337172020"><a href="./docs/zh/2.20.0/installation_guide.md">安装指南</a></p></td>
...
<tr id="row2918153732017">
<td class="cellrowborder" valign="top" width="17.64176417641764%" headers="mcps1.1.4.1.2"><p id="p17918337172020"><a href="./docs/zh/2.15.0/api_reference.md">API参考</a></p></td>
<td class="cellrowborder" valign="top" width="17.64176417641764%" headers="mcps1.1.4.1.3"><p id="p17918337172020"><a href="./docs/zh/2.20.0/api_reference.md">API参考</a></p></td>
